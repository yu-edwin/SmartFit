...
const SITE_CONFIGS = {
    ...
    `,
        ...
        material:
            ".item-material, .product-detail-description, [data-test='composition']",
        brand: "UNIQLO",
    },
    "zara.com": {
        ...
        material:
            ".product-detail-info__composition, .product-detail-description",
        brand: "ZARA",
    },
    "hm.com": {
    ...
    `,
        ...
        image: ".product-image img, .product-detail-main-image-container img",
        material:
            ".pdp-description-list-item, .pdp-description-text, .ProductMaterial-module--details--*",
        brand: "H&M",
    },
    "amazon.com": {
        name: "#productTitle",
        price: "#corePrice_feature_div span.a-offscreen, #priceblock_ourprice, #priceblock_dealprice",
