...
describe("productScraperService", () => {
  ...
  describe("isValidProductUrl", () => {
    it("should return true for valid URLs", () => {
      expect(isValidProductUrl("https://www.uniqlo.com/product/123")).toBe(
        true
      );
      expect(isValidProductUrl("https://www.zara.com/item/456")).toBe(true);
      expect(isValidProductUrl("https://www2.hm.com/product/789")).toBe(true);
    });
