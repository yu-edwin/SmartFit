...
- Further Organization of frontend code
...
**Live URL:** 
- Appetize [SmartFit Application]()
- Testflight (please contact us with your apple email account for invintation)
...
3. Discussed any potential struggles and updates on our current tasks
4. Assign new tasks for organization of tasks for presentation.
...
**FeedBack**
1. Visibility on dark mode was difficult
2. Good if we could delete existing clothing items from the wardrobe
3. Camera tab made viewing navigation bar on bottom difficult to read
4. Image generation was, at times, inaccurate. 
...
**Sprint 4**
- Story Point Estimate: 50
- Sprint 4 Completed: 50 points

**Process Retrospecive**

- What went well?
1. Frontend structure more organized and easier to read
2. Clear assignment of tasks
3. Group meetings on discussing code based on user feedback
4. Consistent branch management since Sprint 3. (Local -> development -> Main (Only at end of sprint))
...
**Testflight**
- Only accessible if you own an iOS device with an apple account
- Please contact dong135790@gmail.com for an invintation to access SmartFits via testflight
